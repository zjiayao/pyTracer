...
from src.sampler.sampler import stratified_sample_2d  # used in BSDF
from src.spectral.spectrum import *
...
class BSDF(object):
	...
	@jit
	def f(self, wo_w: 'Vector', wi_w: 'Vector', flags: 'BDFType'=BDFType.ALL) -> 'Spectrum':
		wi = self.w2l(wi_w)
		wo = self.w2l(wo_w)
